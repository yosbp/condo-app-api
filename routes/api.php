...
use App\Http\Controllers\ImageManipulator;
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::apiResource('condominium', CondominiumController::class)->only(['index', 'store', 'show', 'update']);
    Route::post('condominium/{id}/upload-image', [CondominiumController::class, 'uploadImage']); // Upload image
    ...
    Route::apiResource('expense-category', ExpenseCategoryController::class)->only(['index', 'store', 'update']);
    Route::apiResource('reported-payment', ReportedPaymentController::class)->only(['index', 'store']);
    Route::apiResource('invoice', InvoiceController::class)->only(['index', 'store', 'show']);
    ...
    Route::get('data-to-invoice', [InvoiceController::class, 'dataToInvoice']); // Get data to invoice
});


Route::post('register', [AuthController::class, 'register']);
Route::post('login', [AuthController::class, 'login']);
Route::get('/get-invoice/{id}', [InvoiceController::class, 'generatePDF'])->middleware('throttle:100,1');;
